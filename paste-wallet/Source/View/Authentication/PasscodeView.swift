...
struct PasscodeView: View {
  ...
  init(
    ...
    onPasswordEntered: @escaping @Sendable (String) -> AfterAction
  ) {
  ...
  var biometricButton: some View {
    let icon: [LABiometryType: String] = [
      .faceID: "faceid", .touchID: "touchid", .opticID: "opticid",
    ]
